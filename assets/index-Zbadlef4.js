...
function openDB() {
	return new Promise((resolve, reject) => {
		...
		req.onupgradeneeded = () => {
			req.result.createObjectStore("pairs", { keyPath: "id" });
...
async function loadPairs() {
	...
	return new Promise((resolve) => {
		const req = db.transaction("pairs", "readonly").objectStore("pairs").getAll();
...
async function savePair(pair) {
	...
	return new Promise((resolve, reject) => {
		...
		tx.objectStore("pairs").put(pair);
		tx.oncomplete = () => resolve();
		tx.onerror = () => reject(tx.error);
	});
}
async function deletePairFromDB(id) {
	const db = await openDB();
	return new Promise((resolve) => {
		const tx = db.transaction("pairs", "readwrite");
		tx.objectStore("pairs").delete(id);
		tx.oncomplete = () => resolve();
	});
}
...
function BeforeAfterSlider({ oldUrl, newUrl }) {
	const [blend, setBlend] = (0, import_react.useState)(50);
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "absolute top-2 left-2 bg-black/60 text-white text-xs px-2 py-1 rounded-full",
					children: "Damals"
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					className: "text-white/50 text-xs w-12",
					children: "Damals"
				}),
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					className: "text-white/50 text-xs w-10 text-right",
					children: "Heute"
				})
			]
		})]
...
function CameraView({ basePhoto, baseExif, onSave, onBack, projectId }) {
	...
	const [camIndex, setCamIndex] = (0, import_react.useState)(0);
	...
	const startCamera = (0, import_react.useCallback)(async (deviceId) => {
		...
		try {
			...
			if (msg.includes("NotAllowed") || msg.includes("Permission")) setCameraError("Kamera-Zugriff verweigert. Bitte in den Browser-Einstellungen erlauben.");
			else setCameraError("Kamera konnte nicht gestartet werden. Bitte Seite neu laden.");
		}
	}, []);
	...
	(0, import_react.useEffect)(() => {
		if (alignScore >= 100) {
			...
			if (goodFramesRef.current >= 5) {
				...
				(_capturePhotoRef$curr = capturePhotoRef.current) === null || _capturePhotoRef$curr === void 0 || _capturePhotoRef$curr.call(capturePhotoRef);
			}
	...
	const handleTouchMove = (e) => {
		...
		if (streamRef.current) {
			...
			if (caps.zoom) {
				...
				const next = Math.max(caps.zoom.min, Math.min(caps.zoom.max, cur * delta));
				track.applyConstraints({ advanced: [{ zoom: next }] }).catch(() => {});
				return;
			}
		}
		setVideoScale((prev) => Math.max(1, Math.min(8, prev * delta)));
	};
	const handleTouchEnd = () => {
		pinchRef.current = null;
	};
	const capturePhoto = (0, import_react.useCallback)(() => {
		...
		const newPhotoUrl = canvas.toDataURL("image/jpeg", .92);
		onSave({
			...
			timestamp: Date.now(),
			exif: baseExif,
			cameraFilters: defaultFilters,
			overlayFilters: defaultFilters,
			overlayTransform: defaultTransform,
			projectId
		});
	}, [
		basePhoto,
	...
	if (cameraError) return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
				onClick: onBack,
				className: "absolute top-4 left-4 p-2 rounded-full bg-white/10",
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "absolute top-0 left-0 right-0 z-20 flex items-center justify-between px-4 py-3 bg-gradient-to-b from-black/70 to-transparent",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						onClick: onBack,
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [cameraActive && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "w-2 h-2 rounded-full bg-emerald-400 animate-pulse" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					basePhoto && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: "text-white/60 text-xs w-24",
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
							className: "text-white/60 text-xs w-8 text-right",
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						...
						className: "rounded-full border-4 border-white bg-white/20 backdrop-blur-sm flex items-center justify-center active:scale-95 transition-transform",
						style: {
							width: 72,
							height: 72
						},
...
async function exportPair(pair, label) {
	const [oldImg, newImg] = await Promise.all([loadImage(pair.oldPhotoUrl), loadImage(pair.newPhotoUrl)]);
	...
	a.href = canvas.toDataURL("image/jpeg", .9);
...
function App() {
	var _selectedPair$exif;
	const [view, setView] = (0, import_react.useState)("home");
	const [pairs, setPairs] = (0, import_react.useState)([]);
	const [projects, setProjects] = (0, import_react.useState)([]);
	const [dbReady, setDbReady] = (0, import_react.useState)(false);
	const [basePhoto, setBasePhoto] = (0, import_react.useState)("");
	const [baseExif, setBaseExif] = (0, import_react.useState)();
	const [currentProjectId, setCurrentProjectId] = (0, import_react.useState)();
	const [selectedPair, setSelectedPair] = (0, import_react.useState)(null);
	const [selectedProject, setSelectedProject] = (0, import_react.useState)(null);
	const [showNewProject, setShowNewProject] = (0, import_react.useState)(false);
	const [newProjectName, setNewProjectName] = (0, import_react.useState)("");
	const fileInputRef = (0, import_react.useRef)(null);
	const projectFileInputRef = (0, import_react.useRef)(null);
	(0, import_react.useEffect)(() => {
		Promise.all([loadPairs(), loadProjects()]).then(([p, pr]) => {
			setPairs(p);
			setProjects(pr);
	...
	const openCamera = (file) => {
		...
		reader.onerror = () => console.error("FileReader Fehler");
		reader.onload = (e) => {
			var _e$target;
			const url = (_e$target = e.target) === null || _e$target === void 0 ? void 0 : _e$target.result;
			if (url) {
				setBasePhoto(url);
	...
	const handleSavePair = (pair) => {
		savePair(pair);
		setPairs((prev) => [pair, ...prev]);
		if (pair.projectId) setProjects((prev) => {
			const updated = prev.map((p) => p.id === pair.projectId ? {
				...p,
				pairs: [pair, ...p.pairs]
			} : p);
			const proj = updated.find((p) => p.id === pair.projectId);
	...
	const createProject = (baseUrl, exif) => {
	...
	if (!dbReady) return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "min-h-screen bg-[#0f1117] flex flex-col items-center justify-center gap-4",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "w-8 h-8 border-2 border-emerald-400 border-t-transparent rounded-full animate-spin" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "text-white text-sm",
			children: "RePhoto lädt…"
		})]
	});
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
				...
				onChange: async (e) => {
					...
					reader.onload = async (ev) => {
						var _ev$target;
						createProject((_ev$target = ev.target) === null || _ev$target === void 0 ? void 0 : _ev$target.result, await extractExif(f));
					};
					reader.readAsDataURL(f);
					e.target.value = "";
				}
			}),
			view === "camera" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CameraView, {
				basePhoto,
				baseExif,
			...
			view === "pair-detail" && selectedPair && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "min-h-screen animate-fade-in",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Header, {
					title: "Ergebnis",
					onBack: () => setView(selectedPair.projectId ? "project-detail" : "gallery")
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "pt-16 p-4 space-y-4",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(BeforeAfterSlider, {
							oldUrl: selectedPair.oldPhotoUrl,
							newUrl: selectedPair.newPhotoUrl
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Download, { size: 18 }), " Exportieren"]
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
								onClick: () => {
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "p-4 bg-white/5 rounded-xl text-sm text-white/60",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { children: ["Genauigkeit: ", /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
									className: "text-white font-medium",
									children: [calcAccuracy(selectedPair.overlayTransform), "%"]
								})] }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { children: ["Datum: ", new Date(selectedPair.timestamp).toLocaleString("de-DE")] }),
								((_selectedPair$exif = selectedPair.exif) === null || _selectedPair$exif === void 0 ? void 0 : _selectedPair$exif.focalLengthIn35mm) && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { children: [
									"Brennweite: ",
									selectedPair.exif.focalLengthIn35mm,
									"mm"
								] })
							]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Camera, { size: 16 }), " Nochmals aufnehmen"]
						})
					]
				})]
			}),
			view === "gallery" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "min-h-screen animate-fade-in",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Header, {
					title: "Galerie",
					onBack: () => setView("home")
					...
					className: "pt-16 p-4",
					children: pairs.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "flex flex-col items-center justify-center py-20 text-white/40 space-y-3",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Image, {
							size: 48,
							strokeWidth: 1
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Noch keine Fotos" })]
					}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "grid grid-cols-2 gap-3",
						children: pairs.map((pair) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
							onClick: () => {
								setSelectedPair(pair);
								setView("pair-detail");
							},
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
								src: pair.newPhotoUrl,
								className: "w-full h-full object-cover",
								alt: ""
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 group-active:opacity-100 transition-opacity flex items-end p-2",
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "text-white text-xs",
									children: new Date(pair.timestamp).toLocaleDateString("de-DE")
								})
							})]
						}, pair.id))
					})
			...
			view === "projects" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "min-h-screen animate-fade-in",
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "pt-16 p-4 space-y-3",
						children: projects.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "flex flex-col items-center justify-center py-20 text-white/40 space-y-3",
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Noch keine Projekte" }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
									onClick: () => setShowNewProject(true),
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								className: "text-white/40 text-sm",
								children: [
									pairs.filter((p) => p.projectId === project.id).length,
									" Fotos · ",
					...
					showNewProject && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "fixed inset-0 bg-black/70 flex items-end z-50",
						onClick: () => setShowNewProject(false),
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							onClick: (e) => e.stopPropagation(),
							className: "w-full bg-gray-900 rounded-t-3xl p-6 space-y-4 animate-slide-up",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
									onClick: () => {
										var _projectFileInputRef$;
										return (_projectFileInputRef$ = projectFileInputRef.current) === null || _projectFileInputRef$ === void 0 ? void 0 : _projectFileInputRef$.click();
									},
									disabled: !newProjectName.trim(),
									className: "w-full p-3 rounded-xl bg-emerald-500 text-white font-medium disabled:opacity-40",
									children: "Basis-Foto wählen"
								})
							]
						})
					})
			...
			view === "project-detail" && selectedProject && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "min-h-screen animate-fade-in",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Header, {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
							src: selectedProject.basePhotoUrl,
							className: "w-full h-full object-cover",
							alt: ""
						})
					}), pairs.filter((p) => p.projectId === selectedProject.id).length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "flex flex-col items-center py-10 text-white/40 space-y-3",
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Noch keine Fotos in diesem Projekt" })
					}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "grid grid-cols-2 gap-3",
						children: pairs.filter((p) => p.projectId === selectedProject.id).map((pair) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							onClick: () => {
								setSelectedPair(pair);
								setView("pair-detail");
							},
			...
			view === "home" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "w-24 h-24 rounded-3xl bg-emerald-500/10 border border-emerald-500/30 flex items-center justify-center mb-4",
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
								...
								children: "Zeitreise starten"
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "text-white/50 text-center text-sm max-w-xs",
								children: "Wähle ein historisches Foto und stelle es am gleichen Ort nach"
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
								onClick: () => {
								...
								className: "w-full max-w-sm p-4 rounded-2xl bg-emerald-500 text-white font-semibold text-lg flex items-center justify-center gap-3 active:scale-95 transition-transform",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Camera, { size: 22 }), " Foto nachstellen"]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
								onClick: () => setView("projects"),
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FolderOpen, { size: 20 }), " Projekte verwalten"]
							})
						]
					}),
					pairs.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "p-4 pb-8",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "flex items-center justify-between mb-3",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "text-white/60 text-sm font-medium",
								children: "Zuletzt aufgenommen"
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
								onClick: () => setView("gallery"),
							...
							children: pairs.slice(0, 8).map((pair) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
								onClick: () => {
									setSelectedPair(pair);
									setView("pair-detail");
								},
...
function Header({ title, onBack, action }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "fixed top-0 left-0 right-0 z-10 flex items-center justify-between px-4 py-3 bg-[#0f1117]/90 backdrop-blur-xl border-b border-white/5",
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
				onClick: onBack,
				className: "p-2 -ml-2 rounded-xl flex items-center gap-1 text-white/70",
...
//#endregion
//#region src/main.tsx
(0, import_client.createRoot)(document.getElementById("root")).render(/* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_react.StrictMode, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AppErrorBoundary, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(App, {}) }) }));
//#endregion
